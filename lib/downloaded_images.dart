...
class ImagesDownloadedScreen extends StatefulWidget {
  const ImagesDownloadedScreen({Key? key}) : super(key: key);

  @override
  State<ImagesDownloadedScreen> createState() => _ImagesDownloadedScreenState();
}

class _ImagesDownloadedScreenState extends State<ImagesDownloadedScreen> {
  @override
  var images = [];
  ...
  void initState() {
    ...
    super.initState();
    _newsBloc.add(DownloadedImages());
  }
